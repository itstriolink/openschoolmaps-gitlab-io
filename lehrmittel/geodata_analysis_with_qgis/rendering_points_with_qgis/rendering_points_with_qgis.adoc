= Rendering Points: Displaying Points as a Point Cluster, by Displacement and as Heatmap
...
This worksheet shows how you can use specific point rendering techniques in order to overcome various map challenges taht involve points. We will be using different point renderers offered by QGIS in order to demonstrate how such challenges can be obstacled.
...
IMPORTANT: To view the query for the OSM data in the _.geojson_ file using Overpass Turbo, you can use the following link: https://osm.li/3FH
  ...
  "features": [
    {
      ...
      "properties": {
        ...
        "type": "multipolygon",
        "website": "https://www.yverdonlesbainsregion.ch/de/P944/schloss-von-yverdon-les-bains",
        "wikidata": "Q683081",
        "wikipedia": "de:Schloss Yverdon",
        "@geometry": "center"
      },
      "geometry": {
        "type": "Point",
...
=== Exercise 1: Using the point cluster renderer (TBC)
=== Exercise 2: Using the point displacement renderer (TBC)
=== Exercise 3: Generating heatmaps (TBC)
