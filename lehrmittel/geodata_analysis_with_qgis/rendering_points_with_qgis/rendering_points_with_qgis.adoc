...
----
{
  ...
  "features": [
    ...
    },
    {
      "type": "Feature"...
----
IMPORTANT: More information on the _.geojson_ file extension can be found here: https://geojson.org/
...
image::point_displacement_options.png[Point displacement options, 250] 
