...
=== Weiterführende Themen und Unterlagen

////
TODO:
* Arbeitsblätter von OpenSchoolMaps
* Hinweis auf Plugins wie OpenData
////

=== Dank und Lizenz

Ein grosser Dank geht an Christian Nüssli als Erstautor dieses Dokuments.
Änderungen sind auf dem Repository xxx nachvollziehbar.
