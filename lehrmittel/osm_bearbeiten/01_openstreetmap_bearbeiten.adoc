...
.Ziel
Nach Bearbeiten des zugehörigen Arbeitsblattes sind die SuS in der Lage, auf OSM.org Datenobjekte wie zum Beispiel ein Bänkli, einen Brunnen oder einen Abfallkübel mit Hilfe des iD-Editors zu ergänzen oder abzuändern.
