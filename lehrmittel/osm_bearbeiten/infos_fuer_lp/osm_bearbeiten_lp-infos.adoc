...
[NOTE]
====
OpenStreetMap speichert seine Daten mit so genannten Tags.
Diese siehst du auf der linken Seite im ID-Editor, nachdem du ein Objekt angewählt hast.
image:../../../../bilder/eigenschaften_zugeklappt.PNG["Eigenschaften zugeklappt"]
Wenn du das Feld "Alle Eigenschaften" aufklappst. Sieht du alle Tags, die diesem Objekt hinzugefügt wurden.
image:../../../../bilder/eigenschaften_aufgeklappt.PNG["Eigenschaften zugeklappt"]
Wenn du nicht weisst, welchen Tag du brauchen sollst, kannst du im Cheatsheet nachschauen.
====
