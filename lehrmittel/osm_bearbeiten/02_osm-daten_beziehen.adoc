...
in QGIS darzustellen. Obwohl es auch eine Art Filter ist, nennt es QGIS nicht filertn, sondern regelbaserite Darstellung. Beim filtern 
übergeben wir QGIS einen Ausdruck auf die Felder und ihre Werte, worauf QGIS dann automatisch die Anzeige der Objekte ändert. 
Bei der regelbasierten Darstellung hingegen /TODO
