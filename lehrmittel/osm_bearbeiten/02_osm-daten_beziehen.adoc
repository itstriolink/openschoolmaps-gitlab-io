...
was typischerweise eine administrative Grenze ist (also z.B. Uster) 
_(Tipps, wie man am einfachsten eine solche administrative Grenze erhält sind 
noch in Bearbeitung)_. 

Zu den zwei anderen Problemen folgender Hinweis:

[NOTE]
====
Hinweise zur Nachbearbeitung der Geodaten: 
