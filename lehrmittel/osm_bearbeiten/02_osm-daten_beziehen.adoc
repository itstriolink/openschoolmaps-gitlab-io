...
=== Mit eingebauten QGIS-Tools und der OSM.org Website
...
In unserem Fall filtern wir 'mal nach Bäckereien in Uster (Kanton ZH, Schweiz).
...
Um nach Bäckereien in Uster (Kanton ZH, Schweiz) zu filtern suchen wir nach dem Schlüsselwort _shop_.
...
.Nach Bäckereien in Uster (Kanton ZH, Schweiz) filtern in QGIS
