...
Zuerst besuche die Overpass-Turbo Website unter: http://overpass-turbo.eu/.
...
Klicke auf den rot markierten Button "Wizard". Mit dem Wizard lassen sich ganz einfach Overpass-Abfragen zu erstellen.
