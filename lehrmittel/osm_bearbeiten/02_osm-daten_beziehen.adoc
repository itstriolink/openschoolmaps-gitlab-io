...
Danach öffnet sich ein Fenster mit dem Titel "Abfrageerstellung". In diesem Fenster hat man ein grosses Feld mit dem Namen 
"Datenanbieter spezifischer Filterausdruck". Dort geben wir folgendes ein:
