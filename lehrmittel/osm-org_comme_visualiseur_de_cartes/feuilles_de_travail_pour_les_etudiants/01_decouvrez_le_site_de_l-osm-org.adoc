...
Sur le côté droit se trouvent des boutons gris foncé avec des symboles blancs. Cliquez sur le image:osm-org_als_kartenviewer/minus_button.PNG["Minus Button", 20 , 20]-bouton. Que se passe-t-il ?
