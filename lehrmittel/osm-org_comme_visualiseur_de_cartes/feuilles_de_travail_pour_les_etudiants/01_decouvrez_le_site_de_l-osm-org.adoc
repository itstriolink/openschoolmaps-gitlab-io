...
Lies die Nachricht durch und schliesse sie dann, um mehr von der Landkarte zu 
sehen.
...
Am rechten Seitenrand sind einige dunkelgraue Knöpfe mit weissen Symbolen. Klicke den image:osm-org_als_kartenviewer/minus_button.PNG["Minus Button", 20 , 20]-Knopf. Was passiert?
