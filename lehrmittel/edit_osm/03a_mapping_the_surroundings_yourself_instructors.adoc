...
one click and see the notes as a base map. Here is a http://www.
openstreetmap.org/edit#background=custom:http://tiles.fieldpapers.org
/snapshots/5mq7v8ph/{z}/{x}/{y}.png&map=18/47.22425/8.81875[example] 
