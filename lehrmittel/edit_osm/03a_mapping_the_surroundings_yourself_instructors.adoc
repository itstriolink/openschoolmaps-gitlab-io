...
organized editing and there are these https://wiki.openstreetmap.org/wiki/DE:Organised_Editing_Guidelines["Organized Editing Guidelines"]. 
...
and a digital camera (e.g. camera in smartphone).
