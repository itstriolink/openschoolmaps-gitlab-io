...
sehen Sie im Kapitel _Geodaten erfassen_.
...
Ihnen wird ein neuer Tab geöffnet mit einem Hyperlink.
...
Nun müssen Sie in der decodierten URL alle 3 Koordinatenangaben mit
...
image::umap/online-karte_erstellen/umap_manage_layers.PNG["Manage Layers Menu"]
...
image::umap/online-karte_erstellen/umap_remote_data.PNG["Remote Data Menu"]

Unter _From zoom_ können Sie noch ein minimum Zoom angeben,
für den Fall,
