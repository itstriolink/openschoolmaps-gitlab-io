...
.Ziel
Das Ziel dieser Anleitung ist es, dass Lehrpersonen wie Sie fähig sind, 
mit uMap eine thematische Online-Karte zu erstellen.

.Zielgruppe
Alle, die am Kartiereren (Digialisieren) und am Erstellen einer eigenen Karte interessiert sind.
