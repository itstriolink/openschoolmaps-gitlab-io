...
Nach dem Upload können Sie mit den gleichen Schritten, wie wenn Sie ein bestehendes Bild kopieren möchten, Ihr Bild in uMap einbinden.

NOTE: Ihre hochgeladenen Bilder werden vom Mapillary Team verifiziert.
Daher könnte es einige Stunden dauern, bis Ihre Bilder auf der Webseite verfügbar sind.
