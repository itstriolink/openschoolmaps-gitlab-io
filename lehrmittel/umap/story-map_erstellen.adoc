...
.Beispiel einer mit uMap erstellten Storymap. Kartendaten (C) OpenStreetMap Contributors
...
.Zeitplanung
Je nach grösse Ihrer Storymap sollten Sie etwa 45 Minuten für diese Anleitung planen.
