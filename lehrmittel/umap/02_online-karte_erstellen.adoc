...
Ihnen wird eine URL in die Zwischenablage gespeichert. Das Dialogfenster welches sich nun öffnet beinhaltet 
wahrscheinlich "/missing translation/" als Meldung. Dies ist nicht weiter schlimm, denn die URL wurde in die 
Zwischenablage kopiert. Klicken Sie einfach auf "OK, verstanden".Gehen Sie nun in ihre uMap-Karte.
