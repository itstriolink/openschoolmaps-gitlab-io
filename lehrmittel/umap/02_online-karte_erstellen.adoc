...
Mit anderen Formaten werden möglicherweise nicht alle Attribute mitimportiert.
...
image::umap/online-karte_erstellen/overpass-turbo_export.PNG["Export Abfrage", width="50%"]
