...
Die Resultat werden
als Adressen (Textform) ausgegeben
und als Eintrag in einer Karte.
...
Wähle das Attribut „name“
im Menu unten links aus
und suche nach
dem Begriff Lago.

Damit du sofort siehst,
wie viele Elemente ausgewählt wurden,
...
Deshalb lautet
die topologische Operation _contains_.
Man geht bei der Wahl
der topologischen Operation
also immer vom _Select features from_ aus
und überprüft,
wie er im Verhältnis
zum _By comapring to the features from_ steht.
...
als 200 Einwohner pro km^2^ haben
...
grösser als
200 Einwohner pro km^2^ beträgt
und die zwischen 1800
und 1900 der Schweiz
beigetreten sind.
...
man wissen, wie viele
Einwohner einer Stadt
mehr als 150‘000 CHF
pro Jahr verdienen und
gleichzeitig jünger
...
Verkehrssystem ein
neues Attribut ein,
ob eine Strecke stark
belastet ist oder nicht.
Eine weitere
Möglichkeit wäre
das Einfügen von noch
unbekannten Wanderwegen
in ein GIS-System.
====
endif::show_solutions[]
