...
Eintrag. Klicke anschliessend auf den _OK_-Button um die Hauptorte im Projekt 
anzuzeigen.
...
Nun sollen die Hauptorte noch beschriftet werden. Öffne dazu das _Layereigenschaften_
-Fenster und wähle die Option _Beschriftungen_. Wähle bei _Beschriftungen 
...
NOTE: Die Präfixe findest du, indem du mit *Strg + K* die Suchleiste öffnest, 
...
ID 1 ein Datensatz. Daneben gibt es noch Spalten, welche Attribute enthalten, 
