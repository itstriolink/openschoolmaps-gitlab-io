...
Das Werkzeug _Textdatei als Layer hinzufügen_ um Koordinatenwerte aus einem Textfile 
...
Properties_-Fenster und wähle die Option _Beschriftungen_. Wähle bei _Beschriftungen 
anzeigen_ das Feld _Einzelne Beschriftungen_ und wähle als _Beschreibungsfeld_ das Feld 
...
_Properties_-Fenster für die Kantonsgrenzen.
...
_Anwenden_-Button kannst du deine Einstellungen schon mal im Kartenfenster 
...
Eine neues Werkzeug, welches in QGIS 3 eingeführt wurde, ist die _Suchleiste_.

In QGIS kann die _Suchleiste_ mit dem Tastaturkürzel *Strg + K* geöffnet 
werden.
...
dem Werkzeugkasten _Digitalisierungswerkzeugleiste_ der Button
_Bearbeitungsstatus umschalten_ ausgewählt werden. Das Gleiche geschieht mit
Rechtsmausklick auf den Layer und dann die Option _Bearbeitungsstatus
...
nun aktiviert. Wähle den Button _Polygonobjekt hinzufügen_ und setze Punkte
