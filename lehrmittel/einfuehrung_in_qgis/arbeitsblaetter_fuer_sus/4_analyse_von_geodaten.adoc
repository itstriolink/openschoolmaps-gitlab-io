...
_Ausgabefeld Name_ den Begriff _Dichte_ ein. 
...
Deshalb muss im Feldrechner-Ausdruck die die Umwandlungs-Funktion 
_to_int_ (d.h. "wandle in Ganzzahl um") gewählt werden.
Funktionen erwarten immer einen Ausdruck in Klammern. 
Setze also deinen Ausdruck in die Klammer von _to_int_.
