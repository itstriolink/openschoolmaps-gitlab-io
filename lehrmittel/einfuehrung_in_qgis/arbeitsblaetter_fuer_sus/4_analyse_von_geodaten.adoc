...
Es ist möglich auch die ganze _SQL_-Abfrage zu nutzen, dazu reicht aber der 
_Feldfilter_ nicht aus. Stadtessen nutzen wir dafür den _DB Manager_ welchen 
man unter _Datenbank_ findet.
