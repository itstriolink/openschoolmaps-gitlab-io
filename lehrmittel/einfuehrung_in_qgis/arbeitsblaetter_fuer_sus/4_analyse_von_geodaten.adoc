...
Im oberen Feld steht der Cursor stehtbei Zeile 1 und man kann dort SQL 
schreiben.
Die eigene SQL-Abfrage kann man mit Klick auf den Button _Ausführen_ ausführen. 
Wenn die SQL-Abfrage erfolgreich war, wird das Ergebnis im Ausgabefeld 
angezeigt.
