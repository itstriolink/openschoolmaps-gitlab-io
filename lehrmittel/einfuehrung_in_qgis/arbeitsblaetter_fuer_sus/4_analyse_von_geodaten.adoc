...
In anspruchsvolleren Analysen möchte man möchte die ganze _SQL_-Sprache nutzen. 
...
Wenn man dort aufklappt, sieht man _Projektlayer" und darunter die im Projekt 
