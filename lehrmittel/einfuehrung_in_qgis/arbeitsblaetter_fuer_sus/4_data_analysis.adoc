...
.Solution
SELECT *
FROM Kantonsgrenzen (cantonal boundaries), Seen (lakes)
WHERE Kantonsgrenzen.Beitrittsj (cantonal boundaries.year of accession of) > 1600
AND Seen.Flaeche (lakes.area) > 50
