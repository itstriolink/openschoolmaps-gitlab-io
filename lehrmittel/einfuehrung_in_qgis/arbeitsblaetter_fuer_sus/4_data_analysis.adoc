...
_Create an SQL query for the following question:_ + _"Which cantons have a 
population density greater than 200 inhabitants per km^2^, joined Switzerland 
before 1600 A.D. and have a name that does not begin with the letter 
Z?"_"Which cantons have a population density greater than 200 inhabitants per 
km^2^?
...
with a lake greater then 50km^2^._
