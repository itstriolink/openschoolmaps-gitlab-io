...
den Button _Karte zum Layout hinzufügen_ und ziehe einen Rahmen in der Grösse 
...
Mit Hilfe des Buttons _Eintrag whalen/verschieben_ kann die neue Karte 
...
Mit Hilfe des Buttons _Elementinhalt verschieben_ kann der Inhalt der Karte
...
deinem Resultat zufrieden bist, kannst du durch Klicken des _Projekt speichern_
-Buttons deine Einstellungen sichern.
