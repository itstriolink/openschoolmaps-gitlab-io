...
image::einfuehrung_in_qgis/rasterdaten.png["Rasterdaten", 185, 112]

*Vektordaten*

.Beispiel für Vektordaten
image::einfuehrung_in_qgis/vektordaten.png["Vektordaten", 185, 112]
...
Spaeicherot: Das Vektor-Layer bassiert auf
lokal gespeicherte Daten, während das WMS-Layer
sich auf Serverseitige Daten bezieht. +
...
Karte als ein einzelnes Bild, was es nochamls
verlangsamt.
====
endif::show_solutions[]