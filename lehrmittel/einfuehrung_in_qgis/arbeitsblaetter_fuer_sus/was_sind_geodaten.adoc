...
_Volumen:_ Volumen des Sees in Kubikkilometer [km3] +
_Flaeche:_ Fläche des Sees in Quadratkilometer [km2] +
...
_Staende:_ Anzahl Ständeratssitze (0.5 = Halbkanton) +
_Flaeche:_ Fläche des Kantons in Quadratkilometer [km2] +
====
endif::show_solutions[]
...
Unter <__Title__> findest du den Titel
des WMS-Services und unter <__Abstract__>
