...
rechts auf den Layer und bewegst den Mauszeiger über das Menü _KBS setzen_ und 
...
Gehe anschliessend unter _Projekt_ -> _Properties..._ in den Reiter mit dem Namen 
...
Unter _Titel_ findest du den Titel des WMS-Services und unter _Zusammenfassung_ 
...
muss auf den _Neu_-Button geklickt werden. Gib im Fenster _Neue 
...
Das Vektorformat speichert Anfang- und Endpunkt der Mauer und den Punkt, an dem 
