...
rechts auf den Layer und bewegst den Mauszeiger über das Menu _KBS setzen_ und 
...
Speichere mit dem _Projekt speichern_-Button dein neues Projekt in den Ordner, in 
...
muss auf den _Neu_-Button geklickt werden. Gib im Fenster _Create a New 
