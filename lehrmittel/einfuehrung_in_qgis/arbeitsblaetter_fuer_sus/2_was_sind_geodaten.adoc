...
erhältlich.
Mehr zu Kordinatensysteme siehe später.
...
Koordinatenreferenzsysteme (KRS, englisch coordinate reference system, CRS), 
Koordinatenbezugssysteme (KBS, spatial reference systems, SRS).

In GIS werden Kartenprojektionen mit einem EPSG-Code angegeben.
...
Statusleiste auf den EPSG-Code klicken und ein neues Koordinatensysteme 
auswählen.
...
Danach kannst du das gewünschte Koordinatensysteme auswählen.
