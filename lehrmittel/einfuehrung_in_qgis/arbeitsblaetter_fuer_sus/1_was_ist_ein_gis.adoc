...
und setze ein Kreuz bei der Option _In der Übersicht anzeigen_ anzeigen. Die 
...
Tasten PageUp und PageDown verwendet wird, kann im Menü _Einstelllungen_ -> 
_Optionen..._ unter der Option _Karetnwerkzeuge_ eingestellt werden. Defaultmässig 
