...
de structures topologiques (nodes, ways) et les attributs des objets sous forme 
...
image::osm_editieren/osm-daten_beziehen/startseite.PNG["Startseite", 800, 400]
...
image::osm_editieren/osm-daten_beziehen/resultat.PNG["Resultat, 800, 400]
...
.Résultat révisé
image::osm_editieren/osm-daten_beziehen/resultatNeu.PNG["Resultat Neu", 800, 400]
...
image::osm_editieren/osm-daten_beziehen/brotverkaufsstellen_QGIS.PNG["Brotverkaufsstellen", 800, 400]
...
Ouvrons maintenant le plugin en cliquant sur "Vecteur" dans la barre de menu puis sur "Quick OSM". 
...
de géotraitement" et à l'algorithme "Couper". 
...
.Outil d'exportation HOT onglet 1 "Description de l'Export".
...
.Outil d'exportation HOT onglet 3 "Data".
...
"Créer l'export" (voir ci-dessous).

.Outil d'exportation HOT onglet 4 "Summary".
...
Pour ce faire, allez dans "Outils de gestion de données" dans le menu "Vecteur" 
du QGIS et ensuite dans "Fusionner des Couches Vecteur". 
...
Allez dans "Data Management Tools" dans le menu "Vecteur" du QGIS puis dans "Merge Vector Layers". 
...
.Résultat final
image::osm_editieren/osm-daten_beziehen/brotverkaufsstellen_QGIS.PNG["Brotverkaufsstellen QGIS, 800, 400]
...
image::osm_editieren/osm-daten_beziehen/uster_bäckereien.PNG["Uster Bäckereien", 800, 400]
...
Dans QGIS, cela devrait maintenant ressembler à ceci :

.Boulangeries à Uster
image::osm_editieren/osm-daten_beziehen/uster_bäckereien_nach_regeln.PNG["User Bäckereien nach Regeln", 800, 400]
...
image::osm_editieren/osm-daten_beziehen/brotverkaufsstellen_regelbasiert.PNG["Brotverkaufsstellen Regelbasiert", 800, 400]
