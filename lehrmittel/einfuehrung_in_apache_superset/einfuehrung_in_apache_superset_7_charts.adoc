...
* Direkt darunter ist Chart Nr. 3 zu sehen, benannt mit *"World's Population"*. Dieser zeigt wie gross die Bevölkerung ist und deren Wachstum mittels einer Linie. 
...
das jeweilige Land liegt und wie viel es von dessen Bevölkerung ausmacht. 
