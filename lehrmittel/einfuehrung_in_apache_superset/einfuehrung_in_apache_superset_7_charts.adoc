...
Wenn die Row / Column nur einen Chart umschliesst,
...
=== Nicht-Umsezbare Skizzen

Wie im Abschnitt <<Vorgehen>> schon erwähnt,
kann man nicht alle möglichen Dashboard-Ideen umsetzen.
Ein Beispiel für eine nicht-umsetzbare Skizze zeigt folgendes Bild:

.Eine nicht-umsetzbare Skizze
image::einfuehrung_in_apache_superset/nicht_umsetzbar.PNG[pdfwidth=75%]
...
image::einfuehrung_in_apache_superset/nicht_umsetzbar_Aufteilung.PNG[pdfwidth=75%]
