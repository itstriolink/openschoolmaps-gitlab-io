...
Das Bearbeiten dieses Arbeitsblatts dauert ca. 2 Stunden, je nach deinem Vorwissen.
...
Diese scheint leider sehr dünn und nicht nachgeführt zu sein: Veraltete Begriffe ("Slices" statt "Charts") werden verwendet
...
* Charts (Diagramme), früher "Slice" genannt: Ein "Chart" ist eine Liste, ein Diagramm oder eine Webkarte. Superset kennt zurzeit 48 verschiedene Charts, wobei sieben davon interaktive Webkarten sind.
...
.Visualization Type Sunburst Chart (Entspricht Ringdiagramm/Sunburst-Diagramm in Excel), links am Beispiel der ländlich oder stätlich Wohnenden aufgeteilt in region und Land, rechts der dazugehörige Dialog
