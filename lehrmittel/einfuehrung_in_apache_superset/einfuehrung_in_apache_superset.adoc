...
.eins
image::einfuehrung_in_apache_superset/Ausgangslage.PNG[pdfwidth=50%]

.zwei
image:einfuehrung_in_apache_superset/Ebene0.PNG[pdfwidth=50%]
image:einfuehrung_in_apache_superset/Aufteilung0.PNG[pdfwidth=50%]

.drei
image:einfuehrung_in_apache_superset/Ebene1.PNG[pdfwidth=50%]
image:einfuehrung_in_apache_superset/Aufteilung1.PNG[pdfwidth=50%]

.vier
image:einfuehrung_in_apache_superset/Ebene2.PNG[pdfwidth=50%]
image:einfuehrung_in_apache_superset/Aufteilung2.PNG[pdfwidth=50%]

.fünf
image:einfuehrung_in_apache_superset/Ebene3.PNG[pdfwidth=50%]
image:einfuehrung_in_apache_superset/Aufteilung3.PNG[pdfwidth=50%]

.sechs
image:einfuehrung_in_apache_superset/Ebene4.PNG[pdfwidth=50%]
image:einfuehrung_in_apache_superset/Endprodukt.PNG[pdfwidth=50%]
