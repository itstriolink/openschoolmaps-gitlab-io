...
a|image::einfuehrung_in_apache_superset/Skizze.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Ausgangslage.PNG[pdfwidth=69%]

|*Aufteilung0* |*Verschachtelung0*

a|image::einfuehrung_in_apache_superset/Aufteilung0.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Verschachtelung0.PNG[pdfwidth=69%]

|*Aufteilung1* |*Verschachtelung1*

a|image::einfuehrung_in_apache_superset/Aufteilung1.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Verschachtelung1.PNG[pdfwidth=69%]

|*Aufteilung2* |*Verschachtelung2*

a|image::einfuehrung_in_apache_superset/Aufteilung2.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Verschachtelung2.PNG[pdfwidth=69%]

|*Aufteilung3* |*Verschachtelung3*

a|image::einfuehrung_in_apache_superset/Aufteilung3.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Verschachtelung3.PNG[pdfwidth=69%]

|*Aufteilung4* |*Verschachtelung*

a|image::einfuehrung_in_apache_superset/Aufteilung4.PNG[pdfwidth=69%]
a|image::einfuehrung_in_apache_superset/Endprodukt.PNG[pdfwidth=69%]

|===

Wenn man ein Dashboard entwerfen will, kann es Sinn machen, sich erst eine Skizze zu machen. Wenn man einfach so versucht ein Dashboard zu erstellen....
Wenn man ein Dashboard vom Papier auf Superset bringen will, kann es Sinn machen, das Dashboard erst aufzuteilen. damit man beim Setzen der Rows
und Columns nicht den Überblick verliert. Denn je nach Komplexität k
...
kreuzen. D.h. im ersten Schritt sind entweder nur horizontale oder nur vertikale Linien erlaubt. In unserem Beispiel (*Ausgangslage*) gibt es nur eine Möglichkeit
dies zu tun (Siehe *Ebene0*).
Dieser "Schnitt" ergibt nun zwei "Unterdashboards". Die rote Zahl in den Bildern gibt dabei die "Ebene" bzw. den Verschachtelungsgrad des Elements an (Ein Element kann in
...
Diesen Schritt kann man nun wiederholen, bis alle Charts voneinander getrennt sind (*Ebene1 - Ebene4*). Wenn alle Charts wie in *EBENE4* separiert sind, kann man mit Schritt 2
fortfahren.
...
=== Schritt 2:
Nun kann man mit den Diagrammen die Verschachtelung einfach rekonstruieren. Aus *Ebene0* kann man schliessen, dass man als erstes zwei Rows braucht, die übereinander liegen
(Siehe *Aufteilung1*). Als nächstes braucht man in der oberen Row zwei Columns (Siehe *Aufteilung2*). In der Unteren Row braucht man die zwei Columns nicht, da es keine Charts
gibt, die übereinander stehen.
