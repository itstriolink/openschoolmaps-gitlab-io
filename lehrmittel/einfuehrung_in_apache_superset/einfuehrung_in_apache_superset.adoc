...
a|image::einfuehrung_in_apache_superset/Aufteilung0.PNG[pdfwidth=69%, title="Die einzige Möglichkeit eine Linie durchs Dashboard zu ziehen"]
a|image::einfuehrung_in_apache_superset/Verschachtelung0.PNG[pdfwidth=69%, title="Die waagrechte Linie von Schritt 1 teilt das Dashboard in zwei Rows"]


a|image::einfuehrung_in_apache_superset/Aufteilung1.PNG[pdfwidth=69%, title="In diesem Schritt sind zwei parallele Linien möglich"]
a|image::einfuehrung_in_apache_superset/Verschachtelung1.PNG[pdfwidth=69%, title="Drei Charts können hier direkt eingesetzt werden"]


a|image::einfuehrung_in_apache_superset/Aufteilung2.PNG[pdfwidth=69%, title="Nun ist eine weitere horizontale Linie möglich"]
a|image::einfuehrung_in_apache_superset/Verschachtelung2.PNG[pdfwidth=69%, title="Keine der zwei Rows beinhaltet nur einen Chart, weshalb beide gesetzt werden können"]


a|image::einfuehrung_in_apache_superset/Aufteilung3.PNG[pdfwidth=69%, title="Hier sind wieder zwei senkrechte Linien möglich"]
a|image::einfuehrung_in_apache_superset/Verschachtelung3.PNG[pdfwidth=69%, title="Nur eine Column enthält mehr als einen Chart, weshalb nur eine Column gesetzt wird"]


a|image::einfuehrung_in_apache_superset/Aufteilung4.PNG[pdfwidth=69%, title="Die letzte linie, die gesetzt werden kann"]
a|image::einfuehrung_in_apache_superset/Verschachtelung4.PNG[pdfwidth=69%, title="Hier beinhalten beide Rows nur einen Chart, weshalb keine Rows gesetzt werden"]

a|image::einfuehrung_in_apache_superset/Skizze.PNG[pdfwidth=69%, title="Hier nochmals die Skizze, die das gewünschte Resultat zeigt"]
a|image::einfuehrung_in_apache_superset/Endprodukt.PNG[pdfwidth=69%, title="Hier das Endprodukt, welches der Skizze sehr ähnlich sieht"]
