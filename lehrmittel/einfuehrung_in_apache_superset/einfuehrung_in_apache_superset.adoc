...
Dies kannst du tun, indem du auf das Textfeld unter _Metrics_ klickst und dann ein _aggregate_ (das sind die Einträge, vor welchen *_AGG_* steht) gefolgt von der entsprechenden 
Spalte wählst.
