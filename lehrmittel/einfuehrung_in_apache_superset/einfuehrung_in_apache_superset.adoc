...
== ANHANG: Dashboards Reproduzieren
...
Wenn man ein Dashboard reproduzieren, oder eine Idee vom Papier auf Superset bringen will, kann es Sinn machen, das Dashboard erst aufzuteilen, damit man beim Setzen der Rows
und Columns nicht den Überblick verliert. Hier wird eine Art erläutert, wie man das machen kann. Es ist nicht die effizienteste Art (manche Rows/Columns könnte man
sich sparen), dafür ist sie einfach und für die meisten Anwendungen sollte sie genügen:
