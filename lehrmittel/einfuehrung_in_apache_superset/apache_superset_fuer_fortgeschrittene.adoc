...
Hat man einen Chart erstellt -- beispielsweise der Chart "CIA World Factbook Table" im Kapitel "Upload von Daten" (siehe auch das Arbeitsblatt "Einführung in Apache Superset") -- so will man typischerweie den Chart zu einem Dashboard zusammenstellen und publizieren. 
