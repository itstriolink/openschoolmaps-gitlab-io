...
die all die benötigten Kolonnen visualisiert muss zuerst erstellt werden. Diese _Table_ dient dan als _Annotation Source_ des anderen Diagramms.

Zeit-Annotationen erstellt man als ein _Line Chart_. Deren "Verlauf" ist in anderen Diagrammen mit einer Zeit-Achse visualisierbar.
...
Der Name und die Anzeigeeigenschaften können konfiguriert werden. Die Daten werden von einer
beliebigen Zeitreihen-Chart geholt.
...
Mittels einer roten Box ist jeweils markiert, welche Optionen benötigt werden um ein solches Diagramm zu erstellen.
...
.Visualization Type Mapbox, rechts am Beispiel Punkte in San Francisco, Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/mapbox.png[pdfwidth=75%]

.Visualization Type Deck.gl Scatterplot (entspricht scatter plot in Excel), rechts am Beispiel Punkte in San Francisco, Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_scatterplot.png[pdfwidth=75%]

.Visualization Type Deck.gl Path, rechts am Beispiel Routen in Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_path.png[pdfwidth=75%]

.Visualization Type Deck.gl Arc, rechts am Beispiel Inland-Flüge in den USA, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_arc.png[pdfwidth=75%]

.Visualization Type Country Map, rechts am Beispiel die Geburtenrate 2014 in den französischen Departements, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/country_map.png[pdfwidth=75%]

.Visualization Type Deck.gl Polygon, rechts am Beispiel Bezirke in San Francisco und deren Bevölkerungsdichte, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_polygon.png[pdfwidth=75%]

.Visualization Type World Map, rechts die Bevölkerungdichte der Länder, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/world_map.png[pdfwidth=75%]

.Visualization Type Deck.gl 3D Hexagon, rechts am Beispiel Punkte in San Francisco, Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_3dhexagon.png[pdfwidth=75%]

.Visualization Type Deck.gl Grid, rechts am Beispiel Punkte in San Francisco, Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_grid.png[pdfwidth=75%]

.Visualization Type Deck.gl Screen Grid, rechts am Beispiel Punkte in San Francisco, Kalifornien, links die dazugehörige Eingabemaske
image::einfuehrung_in_apache_superset_fortsetzung/deckgl_screengrid.png[pdfwidth=75%]

.Visualization Type Deck.gl Multiple Layers, rechts am Beispiel die obigen Charts deck.gl Scatterplot und deck.gl Path zusammengeführt, links die dazugehörige Eingabemaske
