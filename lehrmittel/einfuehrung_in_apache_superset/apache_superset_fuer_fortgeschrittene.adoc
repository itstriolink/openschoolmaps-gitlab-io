...
Hier ein Beispiel-Skript mit einer SQL-WINDOW-Funktion, welches den Gebrauch und die Produktion von Elektrizität einer nation vergleicht und den durchschnittlichen Wert berechnet:
