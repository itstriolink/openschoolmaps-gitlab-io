...
Dieses Informationsblatt enthält folgende Themen:
...
Eine gute Dokumentation für Benutzer von Apache Superset scheint erst am Entstehen zu sein. 
Die offizielle, englischsprachige https://superset.incubator.apache.org/[Dokumentation] enthät u.a. ein kleines FAQ, ist sonst aber leider sehr  dünn  und  nicht  nachgeführt (Charts heissen dort beispielsweise noch Slices). 
Wer Fragen hat, dem empfehlen wir, diese auf https://stackoverflow.com/questions/tagged/apache-superset[Stackoverflow] zu stellen.

Eine Dokumentation für Softwareentwickler wird ca. Anfang 2020 auf dem Dokumentenserver der HSR verfügbar sein.

Gerne nehmen wir Feedback entgehen (vgl. https://www.openschoolmaps.ch[OpenSchoolMaps > Kontakt]) und geben weitere Tipps. 
...
NOTE: Die Funktion muss gültige JavaScript-Code sein. 
Und JavaScript ist eine Computersprache, die entsprechende Kenntniss und Tools verlangt.
...
Nachfolgend ein beispielhafter Arbeitsablauf gegeben die Tabelle "Angestellter", die mit der "Abteilung" verknüpft werden soll und zwar über die "Abteilungs-Id" beim Angestellten, eine Zahl, die auf eine bestimmte Abteilungs-Id verweist:
