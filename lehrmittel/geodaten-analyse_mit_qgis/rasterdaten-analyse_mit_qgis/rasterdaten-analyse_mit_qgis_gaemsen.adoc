...
oder Sie öffnen das Menü menu:Layer[Layer hinzufügen].
Dort wählen Sie den Eintrag menu:Rasterlayer hinzufügen…[]
...
öffnen Sie im Menu menu:Raster[] den Eintrag menu:Analyse[Schummerung]
(siehe Abbildung unten).

image:01_schummerungskarte.png[] image:01_schummerung_protokoll.png[]

Als Eingabedatei wählen Sie den Layer "`dhm_rimini`".
Klicken Sie bei "`Schummerung`" (Ausgabedatei) rechts auf btn:[…],
...
und "`Benutzerdefinierte Transparenzeinstellung`" klicken dazu Sie auf btn:[+]
und setzen Sie die beiden Werte "`Von`" und "`Nach`" auf 0
sowie "`Prozent Transparenz`" auf 100 Prozent.
Danach klicken Sie auf btn:[Anwenden].
