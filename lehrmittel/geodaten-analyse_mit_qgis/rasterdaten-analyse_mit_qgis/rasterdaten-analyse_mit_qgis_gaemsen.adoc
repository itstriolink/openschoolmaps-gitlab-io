...
== Allgemeines
Wissen Sie, wo die Gämsen im Zürcher Oberland potentiell leben? Eine multi-kriterielle Rasteranalyse mit einem GIS liefert die Antwort. Diese Übung stammt ursprünglich von Andreas Lienhard, Kanton Zürich (herzlichen Dank!), und wurde dann weiterentwickelt.
...
Starten Sie nun QGIS - oder öffnen ein neues QGIS-Projekt - und stellen Sie das Koordinatenbezugssystem des Projekts unten rechts auf das alte schweizerische Koordinatenbezugssystem EPSG:21781 um.

== Import
Um die beiden Inputdateien „as85.txt“ und „dhm_rimini.txt“ zu laden, können Sie diese entweder mit „Drag & Drop“ ins QGIS hineinziehen, oder Sie öffnen das Menü „Layer“ -> „Layer hinzufügen“. Dort wählen Sie den Eintrag “Rasterlayer hinzufügen…“ und geben die entsprechenden Dateien an. Wählen Sie als Koordinatenbezugssystem EPSG:21781. 

Kontrollieren Sie, dass im Layer-Manager der Layer „dhm_rimini“ oben und damit sichtbar ist, sonst einfach den Layer im Layer-Manager hochziehen. Falls der Layer schwarz dargestellt wird, können Sie dies anpassen, in dem Sie zu Layer-Eigenschaften gehen und bei „Kontrastverbesserung“ von „Zuschneiden auf MinMax“ auf „Strecken auf MinMax“ wechseln (es gibt einige weitere Darstellungsoptionen). Nun sollten Sie etwa das sehen, was nachfolgend dargestellt ist.
...
Um eine Gelände-Schummerungs-Karte aus einem Höhenmodell erzeugen zu können, öffnen Sie im Menu „Raster“ den Eintrag “Analyse“ -> “Schummerung“ (siehe Abbildung unten).

image:01_schummerungskarte.png[] image:01_schummerung_protokoll.png[]

Als Eingabedatei wählen Sie den Layer „dhm_rimini“. Klicken Sie bei „Schummerung“ (Ausgabedatei) rechts auf „…“, eröffnen Sie einen neuen Übungsdaten-Ordner z.B. “gaemse“ und geben Sie den Namen „gelaende.tif“ an (die Endung tif steht für TIFF bzw. GeoTIFF). 

Nach einem Klick auf "Starte" wechselt das Dialog-Fenster automatisch auf den Reiter (Tab, Registerkarte) mit dem Ausführungs-Protokoll. Das Fenster “Schummerung“ mit dem Protokoll können Sie danach schliessen. Danach sollten Sie etwa folgendes Ergebnis mit der Geländeschummerung erhalten:

image::01_schummerungskarte_bsp.png[]

Speichern Sie an dieser Stelle auch das ganze QGIS-Projekt in den Ordner z.B. “gaemse“ mit dem Namen „gaemse.qgz“.
...
Die Gelände-Ausrichtungs-Karte zeigt die Ausrichtung (engl. aspect) des Geländes in Bezug auf Norden. Sie wird mit einem Höhenmodell als Quelle über das Menü “Raster“ -> “Analyse“ -> “Perspektive“ erstellt (vgl. Abbildung oben).

Als Eingabelayer wählen Sie wieder “dhm_rimini“. Wählen Sie bei „Perspektive“ (Ausgabedatei) den Übungsdaten-Ordner (“gaemse“) und den Dateinamen „aspect.tif“: vgl. Abbildung oben. 

Wenn alles richtig gelaufen ist, sollten Sie etwa folgendes sehen (kann auch abweichen):

image::02_perspective_bsp.png[]

Diese Darstellung der Gelände-Ausrichtungs-Karte wollen wir nun aber noch etwas verbessern. Um den Stil eines Layers zu ändern, können Sie per Rechts- oder Doppelklick auf den Layernamen und dessen Eigenschaften zugreifen.

Wählen Sie in der „Symbolisierung“ im ersten Eintrag “Kanaldarstellung“ die Darstellungsart „Einkanalpseudofarbe“. Als Kanal bleibt Ihnen nur der „Kanal 1 (grey)“ zur Auswahl. Nun können Sie “Min“ auf 0 und “Max“ und auf 360 stellen, “Interpolation“ auf “Linear“, als „Farbverlauf“ wählen Sie irgendeinen, damit die automatische Klassifizierung funktioniert (welchen Farbverlauf spielt keine Rolle, da wir die Farben manuell zuweisen werden), den Modus auf “Gleiches Intervall“ und die Klassen-Anzahl auf 5. 

Eine Ausrichtungskarte beinhaltet als Wert einen Winkel (in Grad °), der die Ausrichtung des Geländes repräsentiert. Wir wollen den vier Haupt-Himmelsrichtungen (N, O, S, W) verschiedene Farben zuweisen. Beim Ergebnis der verwendeten Operation entspricht 0° Norden (N). Bei Werten nahe 0° liegt also ein Nordhang vor. Aber auch Werte nahe 360° repräsentieren Nordhänge. Deswegen wurden fünf anstatt nur vier Klassen verwendet. Weisen Sie daher der ersten und letzten Klasse dieselbe Farbe zu, z.B. blau. Der Winkel im Ergebnis ist im Uhrzeigersinn zu verstehen, 90° ist also Osten. Weisen Sie den restlichen drei Klassen unterschiedliche, gut unterscheidbare Farben zu, z.B. rot, gelb, grün.

Wenn Sie wollen, können Sie den Klassen eine sinnvolle „Beschriftung“ geben, z.B. N, O, S, W (und nochmals N).

image::02_perspective_colors.png[]

Wenn Sie alle Einstellungen gemacht haben, gehen Sie auf den Reiter „Transparenz“ (unterhalb Reiter „Symbolisierung“). Hier setzen wir die globale Transparenz auf z.B. 50%, damit man unter der gefärbten Ausrichtungskarte noch die Geländeschummerung sieht.

image::02_perspective_transparenz.png[]

Danach auf “Ok“ klicken (das Dialogfenster schliesst). 

Das Resultat sollte es nun in etwa wie unten abgebildet aussehen. Wenn Sie andere Farben eingestellt haben, ist das nicht weiter schlimm. Hauptsache ist, dass nun die Himmelsrichtungen der Berghänge durch verschiedene Farben visualisiert sind.

image::02_perspective_final.png[]

== Neigungskarte
Mit der Funktion „Neigung“ (engl. slope, Menü “Raster“ -> “Analyse“ -> “Neigung“) wird die Steigung eines als Raster/Grid codierten Geländes dargestellt. Für diese Übung wollen wir die Steigung in Prozent statt in Grad ausdrücken (vgl. unten). Als Eingabedatei wählen Sie wieder den Layer „dhm_rimini“ und geben die Ausgabedatei „slope.tif“ im Übungsdaten-Ordner an. Dann „Starte“.
...
Sie haben nun die Daten so weit vorbereitet, dass wir die Kriterien anwenden können. Zur Erinnerung: Wir suchen diejenigen Gebiete, die folgende Kriterien erfüllen:
...
Um die 0-Werte auch aus der Ansicht herauszufiltern, können wir ihnen noch eine Transparenz zuordnen. In den Layer-Eigenschaften > „Transparenz“ und „Benutzerdefinierte Transparenzeinstellung“ klicken dazu Sie auf „+“ und setzen Sie die beiden Werte „Von“ und „Nach“ auf 0 sowie „Prozent Transparenz“ auf 100 Prozent. Danach klicken Sie auf „Anwenden“.
...
Die gleichen Schritte - zuerst Rasterrechner dann Transparenz – wenden Sie nun für alle weiteren drei Kriterien an, wie folgt:

Für das zweite Kriterium gehen Sie vom Layer bzw. Kanal “Neigung@01“ aus und speichern das Resultat im Übungsdaten-Ordner unter dem Namen „slope_over20perc.tif“ („Ok“ ist noch nicht aktiviert). Selektieren Sie mit dem Rasterrechner in diesem Falle alle Rasterzellen, die steiler als 20% sind. Dann „Ok“.

Für das dritte Kriterium verwenden Sie den Layer “Perspektive“ („aspect.tif“) und filtern alle Rasterzellen heraus, welche zwischen den 135 und 225 Grad liegen (d.h. 180 Grad plus/minus 45 Grad). Damit erhalten Sie alle nach Süden gerichteten Hänge (zur Erinnerung Norden ist 0°). Speichern Sie das Resultat im Übungsdaten-Ordner unter dem Namen „aspect_135_225.tif“. Dann „Ok“.

Für das vierte und letzte Kriterium nehmen wir den Layer “as85“. In diesem sind die verschiedenen Geländearten als Code (Ganzzahl) abgespeichert. Uns interessieren nur alle jene Gebiete, welche die folgenden Nutzungen aufweisen: Wies- und Ackerland, Heimweiden, Maiensässe, Heualpen, Bergwiesen, Alp- und Juraweiden. Diese entsprechen den Codes 8, 9, 10 und 11. Filtern Sie den Layer “as85“ daher nach diesen Codes. Speichern Sie das Resultat im Übungsdaten-Ordner unter dem Dateinamen „as85_sorted.tif“.

Denken Sie daran, für jeden Layer die benutzerdefinierte Transparenz auf 100 Prozent für die Werte von 0 bis 0 zu setzen (vgl. Layer-Eigenschaften).

Probieren Sie dies für alle Schritte aus. Sollten Sie nicht weiterkommen, so ist im nächsten Kapitel jeder Schritt noch mit Lösung und Screenshots beschrieben. 

Nun haben Sie alle nötigen Vorberechnungen gemacht. Nun müssen Sie noch die vier Layer verschneiden (engl. overlay/intersection). Dazu verwenden Sie wieder den Rasterrechner und kombinieren die vier Layer „dhm_rimini_1500_2500“, „slope_over20perc“, „aspect_135_225“ und „as85_sorted“ mit dem logischen UND-Operator. Nennen Sie das Resultat “gut_fuer_gaemsi.tif“ und speichern Sie es wieder in den Übungsdaten-Ordner. Auch hier sollten Sie die benutzerdefinierte Transparenz auf 100 Prozent für die Werte von 0 bis 0 setzen.

Wenn Sie wollen, können Sie auch dieses Ergebnis mit einer Einkanalpseudofarbe oder Palette einfärben:

image::09_gut_fuer_gaemsi_bsp.png[]

Nun wissen wir wo die Gämsen mutmasslich im Zürcher Oberland „wohnen“! Dies zumindest gemäss unseren Daten und Annahmen.
...
Öffnen Sie den Rasterrechner, wählen Sie den Rasterkanal „Neigung@1“ und geben Sie den folgenden Rasterrechnerausdruck ein:
----
...
Im Rasterrechner setzen Sie als Ausgabelayer „aspect_135_225.tif“, wählen den Rasterkanal „Perspektive@1“ und geben den folgenden Rasterrechnerausdruck ein:
----
...
Im Rasterrechner wählen Sie den Rasterkanal „as85@1“, den Ausgabelayer „as85_sorted.tif“ und geben folgenden Rasterrechnerausdruck ein:
----
