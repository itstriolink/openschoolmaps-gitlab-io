...
gesehen höher liegt und eine grosse Stadt wie Zürich wichtiger ist als ein kleines Dorf im Kanton Uri. Somit werden 
...
OSM beschäftigen. Auch ist ein kleines Dorf zu mappen weniger wichtig als eine Grossstadt. Deshalb kann es sein, dass 
...
gibt es noch den ÖV. Züge und Trame fahren definierte Routen entlang einer Schiene ab und Busse 
