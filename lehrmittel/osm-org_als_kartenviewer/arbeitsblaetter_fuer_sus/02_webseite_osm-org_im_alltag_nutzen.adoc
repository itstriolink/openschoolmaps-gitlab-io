...
Und die Daten können nicht nur eine Karte, sondern -- basierend auf den gleichen Daten -- verschiedene Karten für verschiedene Zwecke erzeugen.

Einige Karten bietet die OSM.org-Website zur Auswahl an. 
