...
Wenn du jemandem einen Link zu einem Karten-Ausschnitt oder einer markierten Stelle auf der Karte schicken willst, erhältst du einen solchen wenn du auf den image:osm-org_als_kartenviewer/share_button.PNG["Share Button, 25, 25]-Knopf rechts klickst.
