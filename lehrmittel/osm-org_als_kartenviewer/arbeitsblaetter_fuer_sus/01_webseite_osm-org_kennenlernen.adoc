= OSM.org as map viewer, sheet 1: Get to know the OSM.org website
...
You will get to a website. The main part of which is a map. Can you see the map section? Which area is shown?
...
>
> Hosting is supported by [...] unterstützt.
>
...
(Zoomlevel `0`, whereas depending on the window width, the Earth is already displayed several times), then nothing happens.)
endif::show_solutions[]
ifndef::show_solutions[]
{empty} +
endif::show_solutions[]
...
Enter sights and names of shops, hotels, restaurants and much more. Some of the examples are:
...
Try finding your school, you can use the search field or simply move on the map as learned in the section above. If OpenStreetMap does not find your school by name or address, you can combine both: First search for the location or accommodation, and zoom and drag the map section to where your school should be.
...
Try searchng for your house. Can it be found by your address?
...
If not, search for it again by moving and zooming the map.

Try to find other places you know.
...
A Spanish tourist asks about the way to "Ginebra". Where is she tryin to go to (in Switzerland)?

====
ifdef::show_solutions[]
to Geneva / Genève

Since there is also a place called "Ginebra" in Colombia, it may be necessary to clarify.
endif::show_solutions[]
ifndef::show_solutions[]
{empty} +
{empty} +
