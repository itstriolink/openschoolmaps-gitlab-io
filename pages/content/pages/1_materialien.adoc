...
* Raumanalyse Vektordaten - Autobahn https://gitlab.com/das-g/openschoolmaps.ch/-/jobs/artifacts/autobahn/raw/lehrmittel/geodaten-analyse_mit_qgis/vektordaten-analyse_mit_qgis/vektordaten-analyse_mit_qgis_autobahn.pdf?job=PDFs[Arbeitsblatt]
