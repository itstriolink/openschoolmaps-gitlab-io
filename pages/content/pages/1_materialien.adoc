...
.Apache Superset das Visualisierungs- und Data-Sharing-Werkzeug:
...
* Apache Superset für Fortgeschrittene: https://gitlab.com/openschoolmaps/openschoolmaps.gitlab.io/-/jobs/artifacts/master/raw/lehrmittel/einfuehrung_in_apache_superset/apache_superset_fuer_fortgeschrittene.pdf?job=PDFs[Arbeitsblatt]
