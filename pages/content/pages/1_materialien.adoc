...
.. Raumanalyse mit Hektarrasterdaten:
  * Arbeitsblatt:
  {lehrmittel-url}/weitere_qgis-themen/raumanalyse_mit_hektarrasterdaten/raumanalyse_mit_hektarrasterdaten.pdf[{pdf-icon}{nnbsp}PDF] |
  {lehrmittel-url}/weitere_qgis-themen/raumanalyse_mit_hektarrasterdaten/raumanalyse_mit_hektarrasterdaten.html[{html-icon}{nnbsp}HTML]
  * Daten:
  {lehrmittel-url}/zips/Input-Daten_hektarraster.zip[{zip-icon}{nnbsp}ZIP]
