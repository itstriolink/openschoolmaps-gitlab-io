...
. Präsentation von Geodaten: https://gitlab.com/raytlye/OpenSchoolMaps.ch/-/jobs/artifacts/qgis_kapitel5/raw/lehrmittel/einfuehrung_in_qgis/arbeitsblaetter_fuer_sus/praesentation_von_geodaten.pdf?job=PDFs[Arbeitsblatt] | Lösungen
